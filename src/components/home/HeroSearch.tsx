...
export function HeroSearch() {
  ...
  return (
    <section className="relative bg-brand-orange text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-12 pb-20 md:pt-14 md:pb-24 text-center">
        ...
        >
          <div className="flex flex-1 items-center bg-white px-5 gap-3">
            <svg
              className="w-5 h-5 text-swiggy-gray-light shrink-0"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <input
              ...
              className="flex-1 py-4 text-swiggy-black text-sm focus:outline-none bg-transparent placeholder:text-swiggy-gray-light"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={isPending}
            className="bg-swiggy-black hover:bg-swiggy-black/90 text-white font-bold px-7 py-4 text-sm transition-colors disabled:opacity-60 shrink-0"
          >
            {isPending ? '…' : 'Search'}
          </button>
        </form>
