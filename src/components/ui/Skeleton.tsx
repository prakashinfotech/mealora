  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-card">
      ...
      <div className="p-3 space-y-2">
        ...
        <div className="flex gap-2 pt-2.5 border-t border-swiggy-border mt-1">
    ...
    <div className="space-y-4">
      <div className="bg-white rounded-2xl shadow-card p-5">
        ...
        <div className="space-y-3">
          ...
          <div className="pt-3 border-t border-swiggy-border flex justify-between">
...
export function HomePageSkeleton() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="bg-brand-orange px-4 sm:px-6 pt-12 pb-20">
...
function MenuItemRowSkeleton() {
  return (
    <div className="flex gap-4 py-5 border-b border-swiggy-border last:border-b-0">
...
export function RestaurantDetailSkeleton() {
  return (
    <div className="min-h-screen bg-swiggy-gray-bg pb-24">
      <Navbar />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6">
          <div className="flex gap-5 items-start">
            ...
            <div className="flex-1 space-y-2">
              ...
              <Skeleton className="h-3 w-1/4" />
              <div className="flex items-center gap-4 pt-3 mt-1 border-t border-swiggy-border">
        ...
        <div className="bg-white rounded-2xl overflow-hidden shadow-card">
          {Array.from({ length: 3 }).map((_, s) => (
            <div key={s} className="mb-2">
              <div className="flex items-center justify-between py-4 px-4 sm:px-6 border-b border-swiggy-border">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="bg-white rounded-2xl shadow-card px-4 sm:px-6">
                {Array.from({ length: 3 }).map((_, i) => (
                  <div key={i} className="flex items-center gap-4 py-5 border-b border-swiggy-border last:border-b-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-5">
              ...
              <div className="bg-white rounded-2xl shadow-card p-5">
                ...
                <div className="space-y-3">
                  {[0, 1].map((i) => (
                    <div key={i} className="flex items-start gap-3 p-3 rounded-xl border-2 border-swiggy-border">
              ...
              <div className="bg-white rounded-2xl shadow-card p-5">
                ...
                <div className="space-y-3">
                  {[0, 1, 2].map((i) => (
                    <div key={i} className="flex items-center gap-3 p-3 rounded-xl border-2 border-swiggy-border">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-64 shrink-0">
              <div className="bg-white rounded-2xl shadow-card p-5">
                <div className="flex flex-col items-center text-center pb-5 border-b border-swiggy-border mb-4">
      ...
      <main className="py-8">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2 mb-6">
            <Skeleton className="h-4 w-12" />
            <span className="text-swiggy-border text-sm">›</span>
