...
import { CategoryListClient } from '@/components/admin/menu/CategoryListClient'
...
export async function generateMetadata({ params }: Props) {
  return { title: 'Menu Categories' }
}

export default async function MenuCategoriesPage({ params }: Props) {
  let restaurant
  try {
  ...
  return (
    <div className="max-w-4xl">
      ...
      <CategoryListClient restaurantId={params.id} />
    </div>
  )
}
